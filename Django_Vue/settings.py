...
import Django_Vue.signals  # Import the signals module to ensure it is loaded
...
SECRET_KEY = 'django-insecure-6bc^q_q%)2!(^=_wn#!x!y=xo)fne5w#ljh*g^vc-+_$ryx--g'
...
MIDDLEWARE = [
    ...
    'django.middleware.common.CommonMiddleware',  # Ensure this is after CORS middleware
